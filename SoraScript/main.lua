...
frame.Size = UDim2.fromOffset(300, 420) -- Tinggi ditambah untuk info
...
coordLabel.Text = "POS: X:0 Y:0 Z:0"
...
local function refreshPlayerList()
    ...
    for _,plr in pairs(Players:GetPlayers()) do
        if plr ~= player then
            ...
            b.Size = UDim2.new(1, -5, 0, 35) -- Lebar tombol disesuaikan
            b.BackgroundColor3 = Color3.fromRGB(45,45,45)
            b.Text = plr.DisplayName
            b.TextColor3 = Color3.new(1,1,1) -- Nama jadi putih terang
            b.Font = Enum.Font.GothamBold
            b.TextSize = 14
            Instance.new("UICorner", b).CornerRadius = UDim.new(0,6)
