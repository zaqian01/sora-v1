...
local openLogo = Instance.new("ImageButton", gui)
openLogo.Name = "SoraLogo"
openLogo.Size = UDim2.fromOffset(65, 65)
openLogo.Position = UDim2.fromScale(0.02, 0.5)
openLogo.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
openLogo.Visible = false 
openLogo.Active = true
...
local title = Instance.new("TextLabel", header)
title.Size = UDim2.new(1,-50,1,0); title.Position = UDim2.fromOffset(12,0); title.BackgroundTransparency = 1; title.Text = "SORA"; title.TextColor3 = Color3.fromRGB(0,255,180); title.Font = Enum.Font.GothamBold; title.TextSize = 18; title.TextXAlignment = Enum.TextXAlignment.Left
