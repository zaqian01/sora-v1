...
-- ===== GUI (Updated/Modernized Layout) =====
local gui = Instance.new("ScreenGui", player.PlayerGui)
gui.Name = "SoraV1_Updated"

local frame = Instance.new("Frame", gui)
frame.Size = UDim2.fromOffset(300, 480) -- Ukuran Frame lebih besar untuk menampung semua
...
list.LayoutOrder = 1 -- Posisi setelah Title

local padding = Instance.new("Frame", frame) -- Spacer
padding.Size = UDim2.new(1,0,0,30)
padding.BackgroundTransparency = 1
padding.LayoutOrder = 2
...
infoFrame.Size = UDim2.fromOffset(280, 70)
...
local separator = Instance.new("Frame", frame) -- Visual Separator
separator.Size = UDim2.fromOffset(280, 2)
separator.BackgroundColor3 = Color3.fromRGB(60,60,60)
separator.LayoutOrder = 4

-- Main Buttons start here
local buttonStartOrder = 5 
